...
// import ejs from "../mails/activation-mail.ejs";
// upload course
...
// get single course ----- without purchase access to everyone
exports.getSingleCourse = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isCacheExist) {
            ...
            const course = await course_model_1.default.findById(req.params.id).select("-courseData.videoUrl -courseData.suggestioin -courseData.questions -courseData.links");
...
exports.getAllCourses = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const course = await course_model_1.default.find().select("-courseData.videoUrl -courseData.suggestioin -courseData.questions -courseData.links");
        res.status(200).json({
            success: true,
            course,
        });
...
exports.getCourseByUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!courseExists) {
            return next(new ErrorHandler_1.default("Your are not eligible for this course", 400));
        }
...
exports.addQuestion = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!mongoose_1.default.Types.ObjectId.isValid(contentId)) {
            return next(new ErrorHandler_1.default("Invalid contnent id", 400));
        }
